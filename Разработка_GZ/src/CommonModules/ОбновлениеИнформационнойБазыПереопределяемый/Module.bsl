...
Процедура ПриОпределенииНастроек(Параметры) Экспорт
	...
	Параметры.ПоясненияДляРезультатовОбновления = НСтр("ru='Сведения о результатах обновления версии программы можно также открыть из раздела ""Главное"" - ""Описание изменений программы"".'");
	Параметры.РасположениеОписанияИзмененийПрограммы = НСтр("ru='Описание изменений также можно открыть из раздела ""Главное"" - ""Описание изменений программы"".'");
...
Процедура ПослеОбновленияИнформационнойБазы(Знач ПредыдущаяВерсияИБ, Знач ТекущаяВерсияИБ,
	...
	// Отмена показа обновлений в формате макета.
	// Начиная с 3.0.65 информация об обновлениях показывается через механизм новостного центра
