...
Процедура ВыбратьСертификат(
	...
	Если ЭтоЭлектроннаяПодписьВМоделиСервиса Тогда
		ИмяФормы = "ВыборСертификатаЭлектроннаяПодписьВМоделиСервиса";
	Иначе
		ИмяФормы = "ВыборСертификатаИзСистемногоХранилища";
	КонецЕсли;
	...
	ОткрытьФорму(
		"Обработка.ДокументооборотСКонтролирующимиОрганами.Форма." + ИмяФормы,
		ПараметрыФормы,
		,
		,
		,
