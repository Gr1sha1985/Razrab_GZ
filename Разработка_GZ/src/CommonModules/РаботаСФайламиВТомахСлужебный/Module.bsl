...
//   ДвоичныеДанные           - ДвоичныеДанные - данные, которые будут помещены в том.
//
...
//     * Том - СправочникСсылка.ТомаХраненияФайлов - может быть пустой ссылкой.
//     * ПутьКФайлу - Строка - путь к файлу в томе - может быть пустой строкой;
