...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	ПанелиОтчетовБП.ОпределитьРазделыСВариантамиОтчетов(Разделы);
...
Процедура ЗарегистрироватьИзмененияКлючейВариантовОтчетов(Изменения) Экспорт
	...
	Изменение = Изменения.Добавить();
	Изменение.Отчет = Метаданные.Отчеты.ОборачиваемостьТоваров;
	Изменение.СтароеИмяВарианта = "ОборачиваеомостьТоваров";
	Изменение.АктуальноеИмяВарианта = "ОборачиваемостьТоваров";
	
	Изменение = Изменения.Добавить();
	Изменение.Отчет = Метаданные.Отчеты.СравнениеПродаж;
	Изменение.СтароеИмяВарианта = "ПродажиПоМесяцам";
	Изменение.АктуальноеИмяВарианта = "СравнениеПродажПоНоменклатуре";
