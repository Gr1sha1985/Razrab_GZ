...
Процедура ОбработатьОповещениеОбИзменении(ИдентификаторПравила, КлючОбъекта, Данные) Экспорт
	...
	РегистрыСведений.КассовыеЧекиПодотчетныхЛицЗапросыДетальныхДанных.ПринятьДетальныеДанные(
		ИдентификаторПравила,
		КлючОбъекта,
		Данные);
	
	ШинаМобильныхПриложений.ПринятьОповещение(ИдентификаторПравила, КлючОбъекта, Данные);
