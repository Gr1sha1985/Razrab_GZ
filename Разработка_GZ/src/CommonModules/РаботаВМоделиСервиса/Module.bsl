...
Процедура ОчиститьДанныеОбъектаМетаданных(ПолноеИмяОбъектаМетаданных, ОписаниеОбъектаМетаданных) Экспорт
	...
	ИначеЕсли ЭтоПолноеИмяОбъектаСсылочногоТипа(ПолноеИмяОбъектаМетаданных) Тогда
		...
		Запрос.Текст = СтрЗаменить(
			...
			|	Т.Ссылка КАК Ссылка
			|ИЗ
			|	&Таблица КАК Т", "&Таблица", ПолноеИмяОбъектаМетаданных);
		...
		ИначеЕсли ЭтоПолноеИмяСправочника(ПолноеИмяОбъектаМетаданных) Или ЭтоПолноеИмяПланаСчетов(
			ПолноеИмяОбъектаМетаданных) Или ЭтоПолноеИмяПланаВидовХарактеристик(ПолноеИмяОбъектаМетаданных)
		...
		Пока Выборка.Следующий() Цикл
			...
			УдаляемыйОбъект = Выборка.Ссылка.ПолучитьОбъект(); // СправочникОбъект
