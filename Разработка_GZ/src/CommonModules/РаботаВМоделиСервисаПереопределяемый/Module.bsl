...
Процедура ПриВключенииРазделенияПоОбластямДанных() Экспорт
	...
	// Отключим регламентное задание, выполнение которого планируется в процессе работы пользователя, а не по расписанию.
	КалендарьБухгалтера.ОтключитьОбновлениеЗадачБухгалтераВСервисе();
