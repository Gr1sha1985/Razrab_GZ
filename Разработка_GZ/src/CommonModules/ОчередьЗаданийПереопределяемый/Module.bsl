...
Процедура ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам) Экспорт
	...
	СоответствиеИменПсевдонимам.Вставить(ИнтеграцияСБанками.ИмяМетодаФоновойАктуализации());
	
	ОбменДаннымиСВнешнимиСистемамиБПИнтеграцияПодсистем.ЗарегистрироватьРегламентноеЗаданиеОчередиЗаданий(СоответствиеИменПсевдонимам);
	
	РегистрыСведений.КассовыеЧекиПодотчетныхЛицЗапросыДетальныхДанных.ЗарегистрироватьМетодОчередиЗаданий(
		СоответствиеИменПсевдонимам);
		
	ШинаМобильныхПриложений.ЗарегистрироватьМетодОчередиЗаданий(СоответствиеИменПсевдонимам);
	
	// ЭлектронноеВзаимодействие
	ЭлектронноеВзаимодействие.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
	// Конец ЭлектронноеВзаимодействие
	
	СоответствиеИменПсевдонимам.Вставить("ИнтернетПоддержкаПользователейБП.УстановитьВидимостьНовостейРазделов");
