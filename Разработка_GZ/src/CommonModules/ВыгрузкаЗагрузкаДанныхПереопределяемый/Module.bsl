...
Процедура ПриЗаполненииТиповОбщихДанныхПоддерживающихСопоставлениеСсылокПриЗагрузке(Типы) Экспорт
	...
	Типы.Добавить(Метаданные.Справочники.КлассификаторВидовПредпринимательскойДеятельностиЕНВД);
	
	//Общие справочники с коплексным ключем
	...
	Если Типы.Найти(Метаданные.Справочники.СостояниеВБраке) = Неопределено Тогда
...
Процедура ПриЗаполненииТиповИсключаемыхИзВыгрузкиЗагрузки(Типы) Экспорт
	Типы.Добавить(Метаданные.РегистрыСведений.РеквизитыСервисаПроверокКонтролирующимиОрганами);
	Типы.Добавить(Метаданные.Константы.ИдентификаторПриложенияGoogle);
	Типы.Добавить(Метаданные.Константы.УчетРегулярнойДеятельностиОпределяетсяТарифом);
	Типы.Добавить(Метаданные.Константы.ДоступнаИнтеграцияСПлатформойСамозанятые);
	Типы.Добавить(Метаданные.Справочники.НастройкиИнтеграцииСБанками);
	Типы.Добавить(Метаданные.Справочники.НастройкиИнтеграцииCRM);
	Типы.Добавить(Метаданные.РегистрыСведений.ДокументыИнтеграцииСБанком);
	Типы.Добавить(Метаданные.РегистрыСведений.ДокументыИнтеграцииCRM);
	Типы.Добавить(Метаданные.РегистрыСведений.ПубликуемыеНавигационныеСсылки);
	Типы.Добавить(Метаданные.Константы.ФункциональностьОграничиваетсяТарифом);
	Типы.Добавить(Метаданные.Константы.АдресСервисаИнтеграцииСПлатформойСамозанятые);
	Типы.Добавить(Метаданные.РегистрыСведений.СостоянияИнтеграцииСПлатформойСамозанятые);
	Типы.Добавить(Метаданные.Константы.АдресСервисаРегиональныеСтавкиНалогов);
	Типы.Добавить(Метаданные.РегистрыСведений.БезопасноеХранилищеДанныхОбщее);
...
Процедура ПриРегистрацииОбработчиковВыгрузкиДанных(ТаблицаОбработчиков) Экспорт
	ИнтеграцияСПлатформойСамозанятые.ПриРегистрацииОбработчиковВыгрузкиДанных(ТаблицаОбработчиков);
...
Процедура ПриРегистрацииОбработчиковЗагрузкиДанных(ТаблицаОбработчиков) Экспорт
	ВыгрузкаЗагрузкаДанныхБП.ПриРегистрацииОбработчиковЗагрузкиДанных(ТаблицаОбработчиков);
...
Процедура ПослеЗагрузкиДанных(Контейнер) Экспорт
	// В режиме сервиса сервис 1С-ЭДО не работает
	РегистрыСведений.ЗадачиБухгалтера.СкрытьЗадачуПодключенияК1СЭДОВРежимеСервиса();
	
	СинхронизацияСКалендаремGoogle.ПослеЗагрузкиДанных();
	ОбщегоНазначенияБП.УстановитьЗначенияКонстантПоставкиПослеЗагрузкиДанных();
	ТарификацияБП.УстановитьЗначенияКонстантПоставкиПослеЗагрузкиДанных();
	РегламентированнаяОтчетностьБП.УстановитьОпции1СОтчетности();
	
	ЭлектронныйДокументооборотСКонтролирующимиОрганами.ПослеЗагрузкиДанных(Контейнер);
	
	ОбщегоНазначенияБП.УстановитьДоступностьОплатыСервиса();
