...
//
Функция СоздатьДокументИзвещениеОК_Д_ДвухэтапныйКонкурс(ДанныеЗаполнения) Экспорт
	Если ДанныеЗаполнения <> Неопределено Тогда
		
		НайденныйДокумент = Документы.ГЗ_ИзвещениеОПроведенииЗакупокОК_Д_ДвухЭтапныйКонкурс.НайтиПоРеквизиту("purchaseNumber",ДанныеЗаполнения.purchaseNumber) ;
		
		Если НайденныйДокумент.Пустая() Тогда 
			ДокументГЗ = Документы.ГЗ_ИзвещениеОПроведенииЗакупокОК_Д_ДвухЭтапныйКонкурс.СоздатьДокумент();
		Иначе 	
