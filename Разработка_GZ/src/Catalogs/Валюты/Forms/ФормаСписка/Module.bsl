...
&НаКлиенте
Процедура ВалютыПриАктивизацииСтроки(Элемент)
...
&НаКлиенте
Процедура ВалютыПриИзменении(Элемент)
	Оповестить("КурсыВалют_Изменение");
КонецПроцедуры
...
Процедура Подключаемый_ВыполнитьКоманду(Команда)
	ПодключаемыеКомандыКлиент.НачатьВыполнениеКоманды(ЭтотОбъект, Команда, Элементы.Валюты);
КонецПроцедуры
...
Процедура ВыполнитьКомандуНаСервере(ПараметрыВыполнения)
	ПодключаемыеКоманды.ВыполнитьКоманду(ЭтотОбъект, ПараметрыВыполнения, Элементы.Валюты);
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_ОбновитьКоманды()
	ПодключаемыеКомандыКлиентСервер.ОбновитьКоманды(ЭтотОбъект, Элементы.Валюты);
КонецПроцедуры
// Конец СтандартныеПодсистемы.ПодключаемыеКоманды
